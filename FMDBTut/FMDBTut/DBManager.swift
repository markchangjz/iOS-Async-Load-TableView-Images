			...
			do {
				...
				while results.next() {
					let movie = MovieInfo(movieID: Int(results.int(forColumn: field_MovieID)),
					                      title: String(results.string(forColumn: field_MovieTitle)),
					                      category: String(results.string(forColumn: field_MovieCategory)),
					                      year: Int(results.int(forColumn: field_MovieYear)),
					                      movieURL: String(results.string(forColumn: field_MovieURL)),
					                      coverURL: String(results.string(forColumn:field_MovieCoverURL)),
					                      watched: Bool(results.bool(forColumn: field_MovieWatched)),
